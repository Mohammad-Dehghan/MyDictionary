...
public class MyDictionary extends Application {
    ...
    public static Initializable replaceSceneContent(String fxml) throws Exception {
        ...
        InputStream in = ResourceClass.class.getResourceAsStream(fxml);
        loader.setBuilderFactory(new JavaFXBuilderFactory());
        loader.setLocation(ResourceClass.class.getResource(fxml));
        AnchorPane page;
        try {
    ...
    private Parent createContent() {
        try {
            MainController mc = (MainController) replaceSceneContent("MainPage.fxml");
        } catch (Exception ex) {
